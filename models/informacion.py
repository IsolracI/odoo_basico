...
class informacion(models.Model):
    ...
    def envio_email(self):
        ...
        mail_para = 'gabrieldiacich@gmail.com'  # o enderezo email de destino
        mail_valores = {
    ...
    def actualiza_hora_timezone_usuario(
        ...
        for rexistro in self:
            rexistro.chamado_dende_pedido_e_dende_apidepends(
                rexistro)  # leva rexistro como parametro por que chamado_dende_pedido_e_dende_apidepends ten 2 parametros
    ...
    def chamado_dende_pedido_e_dende_apidepends(self,
        ...
        for rexistro in parametro_cos_datos_a_actualizar:
            rexistro.hora_timezone_usuario = miñasUtilidades.convirte_data_hora_de_utc_a_timezone_do_usuario(
                rexistro.data_hora, self.env.user.tz or 'UTC').strftime(
